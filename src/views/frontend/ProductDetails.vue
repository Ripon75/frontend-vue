            ...
            <div class="row px-xl-5">
                <div class="col-lg-5 pb-5">
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner border" v-if="product.images">
                            <div
                                class="carousel-item"
                                v-for="image in product.images" :key='image.id'
                                :class="{ active: image.is_active }">
                                <img class="w-100 h-100" :src="image.img_src" alt="Image">
                            </div>
                        </div>
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <div class="d-flex">
                        <h4 class="font-weight-semi-bold mb-4" v-if="product.offer_price != 0">{{ currency }} {{ product.offer_price }}</h4>
                        <h4 class="font-weight-semi-bold mb-4" v-else>{{ currency }} {{ product.price }}</h4>
                    ...
                    <p class="mb-4" v-if="product.category">Category : {{ product.category.name }}</p>
                    <div class="d-flex mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <!-- <img src="frontend/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                            style="width: 45px;"> -->
